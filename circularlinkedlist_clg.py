class CNode:
     ...
     def __str__(self):                                                  # to give the string representation of the object
          items=[]
          if self.data == None:
               return str([])
          temp=self
     ...
     def insert_at_beg(self,dv):                                         # insertion at the beginning
          if self.data==self:
               self.data=dv
               self.next=self
          else:
               ...
               #self.data=newnode
     def insert_after_a_node(self,dv,key):                               # insertion after a node,key-->after value,dv-->insert value
          if self.data== None:
               return
          temp=self
          while temp.next!=None:
               ...
               temp=temp.next
                    #self.append(dv)
          return
     def insert_at_any_position(self,dv,pos):                           # insert at any position
          if pos==1:
...
print("after insert in beginning:",ll2)
